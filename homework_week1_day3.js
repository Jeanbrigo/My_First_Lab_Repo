...
const numList = numArrays.slice(-1) // Found the code at https://flexiple.com/javascript/get-last-array-element-javascript/
...
for(let i1 = 0; i1 < numArrays.length ; i1 += 1){
    var currentId = numArrays[i1]
    for(let i2 = 0; i2 < currentId.length ; i2 += 1){
        total = total + currentId[i2]
    }
}
